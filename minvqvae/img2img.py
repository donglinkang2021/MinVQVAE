...
class Img2Img(L.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        if batch_idx == 0:
            ...
            self._add_image(recons, 'test_recon')
        return loss
    ...
    def _common_step(self, batch, batch_idx):
        ...
        recons, loss = self(data_masked)
        return loss, recons, data, data_masked
